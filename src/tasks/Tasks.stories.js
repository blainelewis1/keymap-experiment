...
storiesOf("tasks/StimulusResponseTask", module)
  .add("linear menu", () => (
    <StimulusResponseTask
      stimulus="bear"
      menu="DropdownMenu"
      ...
      onHideStimulus={action("hideStimulus")}
      onShowStimulus={action("showStimulus")}
    />
  ))
  .add("500 ms", () => (
    <StimulusResponseTask
...
storiesOf("tasks/StimulusResponseTask/Stimulus", module)
